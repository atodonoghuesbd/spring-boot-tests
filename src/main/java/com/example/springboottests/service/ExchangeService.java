...
@Service
public class ExchangeService implements
    com.example.springboottests.api.ExchangeService<Transaction> {
   ...
   * <p>
   * If the IDs map to users with differing currencies the transaction should fail. An appropriate
   * failure message should be returned.
   * <p>
   * If the source's currency cardinality is exceeded by the transaction cardinality the transaction
   * should fail. An appropriate failure message should be returned.
   * <p>
  ...
  @Transactional
  protected void executeTransaction(PersonTransportObject source, PersonTransportObject target,
